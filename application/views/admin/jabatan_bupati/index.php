<title>Bupati Masa ke Masa</title>
...
<script>
        ...
        var demo = function() {
            var datatable = $('#kt_datatable').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '<?= base_url('admin/jabatan-bupati/data') ?>',
                            map: function(raw) {
                                var dataset = raw;
                ...
                columns: [
                    {
                        ...
                        template: function(row) {
                            return '<a href="<?= base_url('admin/jabatan-bupati/') ?>'+row.jabatan_bupati_id+'">'+row.jabatan_bupati_nama+'</a>';
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        template: function(row) {
                            return '\
                                <button data-id="'+row.jabatan_bupati_id+'" class="btn btn-sm btn-clean btn-icon mr-2 btnEdit" title="Edit details">\
                                    <span class="svg-icon svg-icon-md">\
                                ...
                                <button data-id="'+row.jabatan_bupati_id+'" class="btn btn-sm btn-clean btn-icon btnDelete" title="Delete">\
                                    <span class="svg-icon svg-icon-md">\
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                                <rect x="0" y="0" width="24" height="24"/>\
            ...
            $(document).on("click", ".btnEdit", function() {
                ...
                window.location.replace("<?= base_url('admin/jabatan-bupati/edit/') ?>" + id);
            });
        }
    ...
    $('.btnNew').click(function() {
        window.location = '<?= base_url('admin/jabatan-bupati/create') ?>'
    })
</script>
