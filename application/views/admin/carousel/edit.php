        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Edit Foto</h3>
                </div>
            </div>
            <div class="card-body">
                <?= form_open('/admin/carousel/update', 'enctype="multipart/form-data" id="carousel-form"') ?>
                    <!-- begin::id -->
                    <input type="hidden" name="carousel_id" value="<?= $carousel['carousel_id'] ?>">
                    <!-- end::id -->
                    <!-- begin::old_foto -->
                    <input type="hidden" name="old_carousel_foto" value="<?= $carousel['carousel_foto'] ?>">
                    <!-- end::old_foto -->
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            value="<?= $carousel['carousel_caption'] ?>"
                        >
