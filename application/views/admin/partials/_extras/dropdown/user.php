...
<!--begin::Header-->
										<div class="d-flex align-items-center justify-content-between flex-wrap p-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?= base_url('assets/admin-assets/media/misc/bg-1.jpg') ?>)">
