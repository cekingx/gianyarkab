        ...
        <div class="card-toolbar">
            ...
            <a href="#" class="btn btn-primary font-weight-bolder btnNew">
                <span class="svg-icon svg-icon-md">
                    ...
                    <!--end::Svg Icon-->
                </span>Tambah Laporan</a>
            <!--end::Button-->            
            <!--begin::Button-->
            <a href="#" class="btn btn-secondary font-weight-bolder btnNew2">
                <span class="svg-icon svg-icon-md">
                    <!--begin::Svg Icon | path:../../../../../../../../metronic/themes/metronic/theme/html/demo2/dist/assets/media/svg/icons/Design/Flatten.svg-->
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        height="24px" viewBox="0 0 24 24" version="1.1">
...
<script>
    ...
    var KTDatatablePengumuman = function () {
        var demo = function() {
                ...
                columns: [
                    {
                        ...
                        template: function(row) {
                            return '<a href="<?= base_url('admin/laporan/') ?>'+row.laporan_id+'">'+row.laporan_nama+'</a>';
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        template: function(row) {
                            return '\
                                <button data-id="'+row.laporan_id+'" class="btn btn-sm btn-clean btn-icon mr-2 btnEdit" title="Edit details">\
                                    <span class="svg-icon svg-icon-md">\
                                ...
                                <button data-id="'+row.laporan_id+'" class="btn btn-sm btn-clean btn-icon btnDelete" title="Delete">\
                                    <span class="svg-icon svg-icon-md">\
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                                <rect x="0" y="0" width="24" height="24"/>\
            ...
            $(document).on("click", ".btnEdit", function() {
                ...
                // console.log("<?= base_url('admin/laporan/edit/') ?>" + id)
                window.location.replace("<?= base_url('admin/laporan/edit/') ?>" + id);
            });
        }
    ...
    $('.btnNew').click(function() {
        window.location = '<?= base_url('admin/laporan/create') ?>'
    })
