<title>Edit Ucapan Perayaan</title>
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-body">
        <form class="form" id="ucapan_perayaan_form">
            <div class="card-body">
                <!-- begin::id -->
                <input type="hidden" name="ucapan_perayaan_id" id="ucapan_perayaan_id" value="<?= $ucapan_perayaan['ucapan_perayaan_id'] ?>">
                <!-- end::id -->
                <!-- begin::teks -->
                <div class="form-group">
                    <label>Teks</label>
                    <input type="text" class="form-control" placeholder="Link" name="ucapan_perayaan_teks"
                        id="ucapan_perayaan_teks" value="<?= $ucapan_perayaan['ucapan_perayaan_teks'] ?>"/>
...
<script>
    ...
    $('#btn-save').click( function() {
        if($('#ucapan_perayaan_teks').val() == '') {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('admin/ucapan-perayaan/update') ?>',
                data: {
                    ucapan_perayaan_id: $('#ucapan_perayaan_id').val(),
