<div class="col-xl-3">
    ...
    <div class="card card-custom bgi-no-repeat gutter-b bg-light"
                    ...
                    <div class="d-flex flex-wrap align-items-center ">
                        ...
                        <div class="symbol symbol-50 symbol-light-danger mr-5">
                            <span class="symbol-label">
                                <img src="<?= base_url('assets/user-assets/media/svg/misc/008-infography.svg') ?>" class="h-50 align-self-center"
                                    alt="" />
                            </span>
                        </div>
                        <!--end:Pic-->
        ...
        <div class="card-body d-flex align-items-center">
            <!--begin::Body-->
            <a href="<?php echo site_url('galeri/video/') ?>">
                ...
                <div class="card-body bg-gray-300 rounded" style="
                    ...
                    <div class="d-flex flex-wrap align-items-center ">
                        ...
                        <div class="symbol symbol-50 symbol-light-danger mr-5">
                            <span class="symbol-label">
                                <img src="<?= base_url('assets/media/svg/misc/008-infography.svg') ?>" class="h-50 align-self-center"
                                    alt="" />
                            </span>
                        </div>
                        <!--end:Pic-->
